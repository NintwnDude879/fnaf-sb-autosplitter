...
state("fnaf9-Win64-Shipping", "v1.05"){
	...
	//Keeps track of when an ending cutscene has started playing (end = 1)
	int aftonEnd: 0x0441D858, 0x58, 0x3B0, 0x118, 0x260, 0xD8;
	int vannyEnd: 0x0441D858, 0x58, 0x3B0, 0x118, 0x2D8, 0xD8;
	int fireEnd: 0x0441D858, 0x58, 0x3B0, 0x118, 0x318, 0xD8;
	int carEnd: 0x0441D858, 0x58, 0x3B0, 0x118, 0x358, 0xD8;
	int escapeEnd: 0x0441D858, 0x58, 0x3B0, 0x118, 0x398, 0xD8;
	...
	int minuteTimer: 0x0440AD80, 0x30, 0x670, 0x230, 0xA38;
	...
	int monGElev: 0x04420F40, 0x98, 0x808, 0x128, 0xA8, 0x68, 0x2D8, 0x4;
	int foy2Elev: 0x04420F40, 0x98, 0x818, 0x128, 0xA8, 0x60, 0x2D8, 0x4;
	int foy1Elev: 0x04420F40, 0x98, 0x818, 0x128, 0xA8, 0xB8, 0x2D8, 0x4;
...
state("fnaf9-Win64-Shipping", "v1.07"){
	...
	//Counter pointers
	int DGens: 0x0441D998, 0x50, 0x98, 0x40, 0x128, 0xA8, 0x50, 0x53C;
	...
	//Player information
	float posX: 0x0441D950, 0x10, 0x120, 0x128, 0x318, 0x138, 0x1D0;
	float posY: 0x0441D950, 0x10, 0x120, 0x128, 0x318, 0x138, 0x1D4;
	float posZ: 0x0441D950, 0x10, 0x120, 0x128, 0x318, 0x138, 0x1D8;

	//Buttons that start cutscenes (pressed = 0)
	int vannyEndButton: 0x04421080, 0x98, 0xA0, 0x128, 0xA8, 0x2F8, 0x240;
	int escapeEndLeaveButtonEast: 0x04421080, 0x98, 0x2D0, 0x128, 0xA8, 0x38, 0x3D8, 0x268;
	int carEndLeaveButton: 0x04421080, 0x98, 0x2D0, 0x128, 0xA8, 0x40, 0x3D8, 0x268;
	int fireEndLeaveButton: 0x04421080, 0x98, 0x2D0, 0x128, 0xA8, 0x48, 0x3D8, 0x268;
	int escapeEndLeaveButtonWest: 0x04421080, 0x98, 0x2D0, 0x128, 0xA8, 0x50, 0x3D8, 0x268;

	//Keeps track of when an ending cutscene has started playing (end = 1)
	int aftonEnd: 0x0441D998, 0x58, 0x388, 0x118, 0x260, 0xD8;
	int vannyEnd: 0x0441D998, 0x58, 0x388, 0x118, 0x2D8, 0xD8;
	int fireEnd: 0x0441D998, 0x58, 0x388, 0x118, 0x318, 0xD8;
	int carEnd: 0x0441D998, 0x58, 0x388, 0x118, 0x358, 0xD8;
	int escapeEnd: 0x0441D998, 0x58, 0x388, 0x118, 0x398, 0xD8;
	int pqEnd: 0x0441D998, 0x58, 0x388, 0x118, 0x3D8, 0xD8;

	//Afton's health (starts at 750, -100 per button)
	float aftonHealth: 0x0441D950, 0xA10, 0x50, 0x190, 0x58, 0x230, 0x0, 0x800;

	//PQ Player Positions
	float pq1X: 0x0441D950, 0x8, 0x8, 0x200, 0x70, 0x260, 0x138, 0x1D4;
	float pq1Y: 0x0441D950, 0x8, 0x8, 0x200, 0x70, 0x260, 0x138, 0x1D0;
	float pq2X: 0x0441D950, 0x8, 0x8, 0x200, 0x70, 0xE60, 0x138, 0x1D4;
	float pq2Y: 0x0441D950, 0x8, 0x8, 0x200, 0x70, 0xE60, 0x138, 0x1D0;
	float pq3X: 0x0441D950, 0x8, 0x8, 0x200, 0x200, 0x38, 0x138, 0x1D4;
	float pq3Y: 0x0441D950, 0x8, 0x8, 0x200, 0x200, 0x38, 0x138, 0x1D0;
	int pq3Attack: 0x0441D950, 0x8, 0x8, 0x200, 0x200, 0x38, 0x120, 0x3F9;

	//Keeps track of items
	int securityBadgeCount: 0x0441CB08, 0x8, 0x10, 0x38, 0xC0;
	int itemCount: 0x0441CB08, 0x8, 0x10, 0x38, 0x138;
	int hippoMagnetUsed: 0x04421080, 0x98, 0xB8, 0x128, 0xA8, 0xA0, 0x338;
	int splashScreen: 0x04421080, 0x98, 0x8A0, 0x128, 0xB8, 0x128, 0x328, 0x3C8;

	//Keeps count of the time
	int hourTimer: 0x0440ADF0, 0x30, 0x670, 0x230, 0x258;
	int minuteTimer: 0x0440ADF0, 0x30, 0x670, 0x230, 0x25C;
	...
	int monGElev: 0x04421080, 0x98, 0x808, 0x128, 0xA8, 0x68, 0x2D8, 0x4;
	int foy2Elev: 0x04421080, 0x98, 0x818, 0x128, 0xA8, 0x60, 0x2D8, 0x4;
	int foy1Elev: 0x04421080, 0x98, 0x818, 0x128, 0xA8, 0xB8, 0x2D8, 0x4;
...
state("fnaf9-Win64-Shipping", "v1.11"){
	...
	//Keeps track of when an ending cutscene has started playing (end = 1)
	int aftonEnd: 0x044251C0, 0x58, 0x3B0, 0x390, 0x260, 0xD8;
	int vannyEnd: 0x044251C0, 0x58, 0x3B0, 0x390, 0x2D8, 0xD8;
	int fireEnd: 0x044251C0, 0x58, 0x3B0, 0x390, 0x318, 0xD8;
	int carEnd: 0x044251C0, 0x58, 0x3B0, 0x390, 0x358, 0xD8;
	int escapeEnd: 0x044251C0, 0x58, 0x3B0, 0x390, 0x398, 0xD8;
	...
	//Keeps count of the time
	int hourTimer: 0x044126F0, 0x30, 0x50, 0x680, 0x230, 0x10;
	int minuteTimer: 0x044126F0, 0x30, 0x50, 0x680, 0x230, 0x14;
	...
	int monGElev: 0x044288B0, 0x98, 0x808, 0x128, 0xA8, 0xA0, 0x2E8;
	int foy2Elev: 0x044288B0, 0x98, 0x818, 0x128, 0xA8, 0xA8, 0x2D8, 0x4;
	int foy1Elev: 0x044288B0, 0x98, 0x818, 0x128, 0xA8, 0xB8, 0x2D8, 0x4;
	...
	int roxyElev: 0x044288B0, 0x98, 0x848, 0x128, 0xA8, 0x288, 0x2E8;
